### Functions: FP-growth input arrangement and running.
### Author: Yizhou Li and Yangfang Xiong
...
parser.add_argument(
    '-i',help='fpgrowth input filename')
parser.add_argument(
...
## Get input pancaner mutation info for each donor
...
### singal mutation use `s` max
cmd1 = 'fpgrowth -ts -v" %a" -s-{}m1n1 {} {}'.format(supp_threshold,input_path,output_path_1)
